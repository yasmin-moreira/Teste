...
<head>
    ...
    <title>Métodos de Estudos</title>
...
<body>
    ...
    <div class="metodo-container">
        <div class="metodo">
            <div class="title">
                Conheça alguns métodos de estudos
            </div>
            <div class="parte-metodos" id="parte-metodos">
    ...
    <script src="./assets/Scripts/metodosEstudo.js"></script>
